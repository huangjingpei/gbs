...
std::string GetWindowsProductIDFromRegistery()
{
	HKEY hKey;
...
std::string GetMachineIdFromRegistry()
{
	HKEY hKey;
...
std::string OBSHttpClient::GetDeviceID()
{
	HRESULT hres;
	std::string deviceID;
...
std::string OBSHttpClient::GetWindowsProductID()
{
	HRESULT hres;
